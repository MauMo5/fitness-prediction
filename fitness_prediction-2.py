...
def user_input_features():
  ...
  Indiceact= st.number_input('Índice de actividad: ', min_value=0, max_value=10, value=0, step=1)
  Fumar= st.number_input('Fuma 0=no 1=sí: ', min_value=0, max_value=1, value=0, step=1)
  Género= st.number_input('Género 0=hombre 1=mujer: ', min_value=0, max_value=1, value=0, step=1)
...
X = fitnessdf=.drop(columns='is_fitt')
Y = fitnessdf['is_fit']
